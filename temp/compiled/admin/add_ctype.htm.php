...
<table cellspacing="1" cellpadding="3" width="100%">
  <tr>
    ...
    <?php $_from = $this->_var['cb']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cb_0_85224500_1342669450');if (count($_from)):
    foreach ($_from AS $this->_var['cb_0_85224500_1342669450']):
?>
    <option <?php if ($this->_var['ctype']['cb_name'] == $this->_var['cb_0_85224500_1342669450']['id']): ?>selected="selected"<?php endif; ?> value="<?php echo $this->_var['cb_0_85224500_1342669450']['id']; ?>"><?php echo $this->_var['cb_0_85224500_1342669450']['cbrand_name']; ?></option>
